from PyQt5.QtWidgets import QMainWindow, QWidget, QVBoxLayout, QSplitter, QTabWidget, QTextEdit, QPushButton, QListWidget, QAction, QFileDialog, QInputDialog, QMessageBox, QShortcut, QLabel, QLineEdit, QDialog, QApplication
...
class AIAutomationIDEApp(QMainWindow):
    ...
    def open_multiple_files(self, filepaths=None):
        ...
        for filepath in filepaths:
            ...
            self.notebook.setCurrentWidget(new_tab)
            self.apply_syntax_highlighting(new_tab)
            print(f"Opened file: {filepath}")  # Debug statement
    ...
    def save_file(self):
        ...
        if current_tab not in self.open_files or self.open_files[current_tab] is None:
            ...
            print(f"Saved file: {filepath}")  # Debug statement
            print(f"Current open files: {self.open_files}")  # Debug statement
    ...
    def save_as_file(self):
        ...
        print(f"Saved file as: {filepath}")  # Debug statement
        print(f"Current open files: {self.open_files}")  # Debug statement
    ...
    def run_current_file(self):
        ...
        print(f"Ran file: {filepath}")  # Debug statement
        print(f"Current open files: {self.open_files}")  # Debug statement
